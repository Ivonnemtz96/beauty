...
<main>
    ...
    <section id="home" class="slider-area fix p-relative">
        <div class="slider-active" style="background: #00173c">
            <div class="single-slider slider-bg d-flex align-items-center" style="
              background-image: url(/img/slider/03.jpg?=2);
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="about-content s-about-content wow fadeInRight animated" data-animation="fadeInRight"
                        ...
                        <p>
                            Te damos la bienvenida a un oasis de rejuvenecimiento y cuidado facial.
                            Sumérgete en un mundo de posibilidades para realzar tu belleza natural y mantener una piel
    ...
    <!-- about-area-end -->
    <!-- feature-area -->
    <section class="feature-area p-relative fix pb-120">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="section-title center-align mb-50 text-center">
                        ...
                        <h2>¡Transforma tu belleza hoy mismo!</h2>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
    ...
    <!-- gallery-area-end -->
    <!-- testimonial-area -->
    <section class="testimonial-area pt-120 p-relative fix" style="
